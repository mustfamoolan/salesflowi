        ...
        <div className="min-h-screen bg-gray-100 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <a
                        href="/customers"
                        className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow group text-center"
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">العملاء</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">الديون</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">الأقساط</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">الفواتير</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">المصروفات</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">التقارير</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">نقطة البيع</h4>
                    </a>
                    ...
                    >
                        ...
                        <h4 className="font-semibold text-gray-900 text-sm">الإعدادات</h4>
                    </a>
                </div>
            </div>
        </div>
